...
function myFunction(){
	alert("Testing sample javascript result page!!!!!");
}
...
//$("#sun_shower").hide();
//document.getElementById("sun_shower").style.display = "none"; 
//document.getElementById("sun_shower").style.visibility = "hidden";
